...
### Example Program from PETSc: ex11.c

PETSc tutorial example ex11.c provides a good overview of the kind of flexible interface we want to be able to develop for a FVM model to solve geophysical fluid flow problems. Please refer to this example as a reference to help us understand how to integrate the modules together, and the kind of functions that remain to be implemented, and the kind of workflow we are going to mimic with HYDRA.
